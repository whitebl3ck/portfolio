          ...
          <div key={group.group} className="mb-6">
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-1">
              {group.items.map((skill, idx) => (
                <motion.div
                  key={skill.name}
                  className="bg-white sm:w-3xl rounded-lg shadow-md p-2 flex flex-col items-center justify-center aspect-square cursor-pointer hover:scale-105 hover:shadow-xl transition-transform"
                  initial="offscreen"
