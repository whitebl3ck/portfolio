...
const paragraphs = [
  ...
  "Beyond code, I am someone whose life is centered on faith and purpose. I love God deeply, and I draw strength and inspiration from my values every day. In my free time, you'll often find me on the football pitch, enjoying the beautiful game and staying active."
];

const image = grad; // Update with the path to your image
  ...
  return (
    <div className="w-full h-full flex flex-col md:flex-row items-center justify-center p-6 md:p-12">
      ...
      <div className="w-full md:w-1/3 flex items-center justify-center mb-8 md:mb-0">
        ...
        <div className="w-48 h-48 sm:w-64 sm:h-64 md:w-80 md:h-80 rounded-full flex items-center justify-center text-white text-2xl font-bold">
          <img 
            src={image} 
      ...
      <div className="w-full md:w-2/3 flex items-center justify-center text-center md:text-left">
        <div className='text-gray-300 p-6 md:p-8 relative'>
          ...
          <motion.h1 
            className="text-3xl sm:text-4xl md:text-7xl font-bold mb-4 relative"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            ...
            <motion.span
              ...
              className="inline-block w-1 md:w-2 h-8 sm:h-10 md:h-16 bg-gray-300 ml-2"
            />
          </motion.h1>
          <p className={`text-base sm:text-lg md:text-2xl max-w-4xl relative transition-opacity duration-500 leading-relaxed ${fade ? 'opacity-100' : 'opacity-0'}`} dangerouslySetInnerHTML={{ __html: paragraphs[index] }} />
        </div>
      </div>
    </div>
  );
